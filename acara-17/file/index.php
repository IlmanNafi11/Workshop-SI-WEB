...
<div class="container">
    ...
    if (isset($_GET['alert'])) {
        if ($_GET['alert'] == "gagal_ukuran") {
            echo '<div class="alert alert-warning"><strong>Warning!</strong> Ukuran File Terlalu Besar</div>';
        } elseif ($_GET['alert'] == "gagal_ektensi") {
            echo '<div class="alert alert-warning"><strong>Warning!</strong> Ekstensi Gambar Tidak Diperbolehkan</div>';
        } elseif ($_GET['alert'] == "simpan") {
            echo '<div class="alert alert-success"><strong>Success!</strong> Gambar Berhasil Disimpan</div>';
        }
    }
    ?>
